...
public class Propuesto_5_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		imprimir();    	
    	imprimir("Tamaño total del arreglo :  " + an.tamanio());    	
    	imprimir("Promedio de todas las notas :  " + an.notaPromedio());
    	imprimir("Nota mayor :  " + an.notaMayor());
    	imprimir("Nota menor :  " + an.notaMenor());
    	imprimir("Cantidad de Notas aprobadas  :  " + an.cantNotasAprobatorias());
    	imprimir("Cantidad de Nota desaprobadas :  " + an.cantNotasDesaprobatorias());
    	imprimir("Cantidad de Notas mayores a 15 :  " + an.cantNotasMayoresA15());
    	imprimir("Primera Notas aprobatoria:  " + an.posPrimeraNotaAprobatoria());
    	imprimir("Penultima Nota desaprobatoria :  " + an.PenultimaNotaDesaprobatoria());
